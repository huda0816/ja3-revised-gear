UndefineClass('Sidor_Backpack')
DefineClass.Sidor_Backpack = {
	__parents = { "Backpack" },
	__generated_by_class = "ItemInventoryItemCompositeDef",

	object_class = "Backpack",
	Icon = "Mod/ii6mKUf/Icons/Backpack_Sidor.png",
...
UndefineClass('Vietnam_Backpack')
DefineClass.Vietnam_Backpack = {
	__parents = { "Backpack" },
	__generated_by_class = "ItemInventoryItemCompositeDef",

	object_class = "Backpack",
	Icon = "Mod/ii6mKUf/Icons/Backpack_Vietnam.png",
...
DefineClass.Bergen_Backpack = {
	__parents = { "Backpack" },
	__generated_by_class = "ItemInventoryItemCompositeDef",

	object_class = "Backpack",
	Icon = "Mod/ii6mKUf/Icons/Backpack_Bergen.png",
	DisplayName = "US Vietnam backpack",
	DisplayNamePlural = "US Vietnam backpack",
	AdditionalHint = "3 large slots",
    Weight = 3,
