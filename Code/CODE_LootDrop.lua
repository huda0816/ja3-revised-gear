...
-- Holster_Basic
-- Holster_Drop_Leg_Bag
-- LBE_Basic_Army_Rig_new
-- LBE_Modern_Army_Rig_new
-- LBE_Combat_Vest_new
-- LBE_Heavy_Duty_Vest_new
-- Backpack_Retro
-- Backpack_Mule
-- Backpack_Combat
-- Backpack_Modern
...
LBERarityTable = {
	...
	{Affiliation = "Legion", id = "LBE_Basic_Rig_new", Rarity = 8},
	{Affiliation = "Legion", id = "LBE_Cheap_Vest_new", Rarity = 10},
	{Affiliation = "Legion", id = "LBE_Combat_Vest_new", Rarity = 6},
	...
	{Affiliation = "Rebel", id = "LBE_Basic_Rig_new", Rarity = 8},
	{Affiliation = "Rebel", id = "LBE_Cheap_Vest_new", Rarity = 6},
	{Affiliation = "Rebel", id = "LBE_Combat_Vest_new", Rarity = 6},
	...
	{Affiliation = "Army", id = "LBE_Basic_Army_Rig_new", Rarity = 10},
	{Affiliation = "Army", id = "LBE_Modern_Army_Rig_new", Rarity = 8},
	{Affiliation = "Army", id = "LBE_Basic_Rig_new", Rarity = 8},
	{Affiliation = "Army", id = "LBE_Combat_Vest_new", Rarity = 6},
	{Affiliation = "Army", id = "LBE_Heavy_Duty_Vest_new", Rarity = 6},
	...
	{Affiliation = "Adonis", id = "LBE_Modern_Army_Rig_new", Rarity = 10},
	{Affiliation = "Adonis", id = "LBE_Heavy_Duty_Vest_new", Rarity = 8},
	...
	{Affiliation = "SuperSoldiers", id = "LBE_SWAT_Vest_new", Rarity = 10},
