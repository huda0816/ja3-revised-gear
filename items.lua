...
PlaceObj('ModItemXTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "NextUnit",
			'ActionName', T(296549589345, --[[ModItemXTemplate Inventory ActionName]] "Next Unit"),
			'ActionShortcut', "Tab",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "PrevUnit",
			'ActionName', T(592534066510, --[[ModItemXTemplate Inventory ActionName]] "Prev Unit"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "NextSquad",
			'ActionName', T(590010087592, --[[ModItemXTemplate Inventory ActionName]] "Next Squad"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "PrevSquad",
			'ActionName', T(184135862887, --[[ModItemXTemplate Inventory ActionName]] "Prev Squad"),
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionName', T(683108109642, --[[ModItemXTemplate Inventory ActionName]] "Active Weapon I"),
			'ActionShortcut', "Z",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionName', T(890506059265, --[[ModItemXTemplate Inventory ActionName]] "Active Weapon II"),
			'ActionShortcut', "X",
			'ActionButtonTemplate', "InventoryActionBarButton",
			'ActionState', function (self, host)
				          return not host.compare_mode and "enabled" or "hidden"
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Primary",
			'ActionName', T(764149793051, --[[ModItemXTemplate Inventory ActionName]] "Loadout I"),
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Secondary",
			'ActionName', T(421936762394, --[[ModItemXTemplate Inventory ActionName]] "Loadout II"),
			'ActionToolbar', "InventoryActionBar",
			'ActionShortcut', "X",
		...
		PlaceObj('XTemplateAction', {
			'ActionId', "Actions",
			'ActionName', T(484065635736, --[[ModItemXTemplate Inventory ActionName]] "Item Menu"),
			'ActionToolbar', "InventoryActionBar",
		...
		PlaceObj('XTemplateAction', {
			...
			'ActionName', T(818396666423, --[[ModItemXTemplate Inventory ActionName]] "Compare"),
			'ActionToolbar', "InventoryActionBar",
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', nil, {
								...
								PlaceObj('XTemplateWindow', {
									...
									'RolloverTitle', T(402957648985, --[[ModItemXTemplate Inventory RolloverTitle]] "AP"),
									'Id', "idWeapons1",
							...
							PlaceObj('XTemplateWindow', nil, {
								...
								PlaceObj('XTemplateWindow', {
									'__class', "XToggleButton",
									'RolloverTemplate', "ChangeActiveWeaponAPRollover",
									'RolloverTitle', T(143721442935, --[[ModItemXTemplate Inventory RolloverTitle]] "AP"),
									'Id', "idWeapons2",
									'Margins', box(0, 5, 39, 0),
									'HAlign', "right",
									'VAlign', "top",
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(150166550153, --[[ModItemXTemplate Inventory Text]] "Not Enough AP "),
						'TextHAlign', "center",
					}),
					}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Translate', true,
					'Text', T(478190433750, --[[ModItemXTemplate Inventory Text]] "Loot"),
					'TextHAlign', "center",
					'TextVAlign', "center",
				}),
				PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'Translate', true,
									'Text', T(390335878123, --[[ModItemXTemplate Inventory Text]] "The selected squad is not in the sector"),
									'TextHAlign', "center",
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateWindow', nil, {
												PlaceObj('XTemplateWindow', {
													...
													'Translate', true,
													'Text', T(561829480196, --[[ModItemXTemplate Inventory Text]] "BAG"),
													'TextVAlign', "center",
												}),
												}),
											PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(126618871320, --[[ModItemXTemplate Inventory Text]] "Inventory is full"),
										'HideOnEmpty', true,
									}),
									PlaceObj('XTemplateTemplate', {
										'comment', "takeall",
							...
							PlaceObj('XTemplateAction', {
								'ActionId', "AmmoPack",
								'ActionName', T(375469866541, --[[ModItemXTemplate Inventory ActionName]] "SQUAD SUPPLIES"),
								'ActionShortcut', "A",
								'ActionState', function (self, host)
									                    local context = host:GetContext()
							...
							PlaceObj('XTemplateAction', {
								'ActionId', "TakeAll",
								'ActionName', T(639545531759, --[[ModItemXTemplate Inventory ActionName]] "TAKE ALL"),
								'ActionShortcut', "T",
								'ActionGamepad', "Start",
								'ActionState', function (self, host)
					...
					PlaceObj('XTemplateMode', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateWindow', {
												...
												'TextStyle', "InventoryBackpackTitle",
												'Translate', true,
												'Text', T(915130334188, --[[ModItemXTemplate Inventory Text]] "BAG"),
												'TextVAlign', "center",
											}),
											}),
										PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "InventoryActionsTextRedBig",
										'Translate', true,
										'Text', T(563398645265, --[[ModItemXTemplate Inventory Text]] "Inventory is full"),
										'HideOnEmpty', true,
									}),
									PlaceObj('XTemplateTemplate', {
										'comment', "take loot",
							...
							PlaceObj('XTemplateAction', {
								'ActionId', "Loot",
								'ActionName', T(499695415908, --[[ModItemXTemplate Inventory ActionName]] "Show Loot"),
							...
							PlaceObj('XTemplateAction', {
								'ActionId', "TakeLoot",
								'ActionName', T(806548941674, --[[ModItemXTemplate Inventory ActionName]] "Take Loot"),
								'ActionToolbar', "ActionBarCenter",
								'ActionShortcut', "T",
								'ActionGamepad', "Start",
								'ActionState', function (self, host)
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'TextStyle', "InventoryContainerTitle",
					'Translate', true,
					'Text', T(467859146490, --[[ModItemXTemplate Inventory Text]] "Squad Backpacks"),
				}),
				PlaceObj('XTemplateWindow', {
					'comment', "right",
					'__class', "XContentTemplate",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "InventoryBackpackTitle",
										'Translate', true,
										'Text', T(326965486029, --[[ModItemXTemplate Inventory Text]] "<Nick> EQUIPMENT <GetCurrentWeight()>/<GetMaxWeight()> Kg"),
										'TextVAlign', "center",
									}, {
										PlaceObj('XTemplateFunc', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "InventoryBackpackTitle",
										'Translate', true,
										'Text', T(767580368547, --[[ModItemXTemplate Inventory Text]] "Squad Supplies <GetSquadBagWeight()> Kg"),
										'TextVAlign', "center",
									}, {
										PlaceObj('XTemplateFunc', {
											'name', "SetHightlighted(self, show)",
